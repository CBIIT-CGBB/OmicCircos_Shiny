...
cir        <- segAnglePo(seg.d, seg="seg1", angle.start=45, angle.end=316);
...
pdf("do_cluster_circle02.pdf", 6, 6);
par(mar=c(2,2,2,2));
plot(c(1:800), c(1:800), type="n", axes=F, xlab="", ylab="", main="", asp=1);
cluster.circle(400, 400, 60, 200, data=dat.h, angle.start=45,  angle.end=314, tip=T, tip.cex=0.01,
