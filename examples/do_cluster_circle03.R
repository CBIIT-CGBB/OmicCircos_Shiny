...
cir        <- segAnglePo(seg.d, seg="seg1", angle.start=135, angle.end=405);
...
pdf("do_cluster_circle03.pdf", 6, 6);
par(mar=c(2,2,2,2));
plot(c(1:800), c(1:800), type="n", axes=F, xlab="", ylab="", main="", asp=1);
cluster.circle(400, 400, 80, 200, data=dat.h, angle.start=135,  angle.end=403, tip=T, tip.cex=0.01,
